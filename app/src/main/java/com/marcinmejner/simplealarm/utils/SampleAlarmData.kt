...
class SampleAlarmData {
    ...
    fun getSampleAlarms(): List<AlarmEntity> {
        ...
        alarms.add(AlarmEntity(alarmMinutes = "20", alarmHours = "14", name = "Testowy Alarm", isSnoozeEnabled = true, snoozeMinutes = 50 ))
        ...
        alarms.add(AlarmEntity(alarmMinutes = "50", alarmHours = "11", name = "Mój", isSnoozeEnabled = true, snoozeMinutes = 7 ))
